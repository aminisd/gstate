...
const StructuredData = ({ type, data }) => {
  ...
  const currentUrl = `https://gstate.vercel.app${location.pathname}`;
  ...
  const schemas = {
    ...
    organization: {
      ...
      name: 'GState',
      url: 'https://gstate.vercel.app',
      logo: 'https://gstate.vercel.app/logo.png',
      sameAs: [
        'https://github.com/99Gssabek/gstate',
    ...
    aiHub: {
      ...
      url: 'https://gstate.vercel.app/ai-property-hub',
      offers: {
        '@type': 'Offer',
        price: '0',
        priceCurrency: 'INR',
