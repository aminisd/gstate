...
const socialLinks = [
  ...
  { icon: Github, href: 'https://github.com/99Gssabek/gstate', label: 'GitHub', color: 'bg-[#333]', hoverColor: 'hover:bg-gray-800' },
];
...
const contactInfo = [
  ...
  { 
    icon: Mail, 
    text: 'support@gstate.com',
    href: 'mailto:support@gstate.com' 
  },
];
