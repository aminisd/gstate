    ...
    <html lang="en">
      ...
      <body>
        <div class="container">
          ...
          <div class="info">
            <p>The GState API is running properly. This backend serves property listings, user authentication, 
            and AI analysis features for the GState property platform.</p>
          </div>
          
          <div class="footer">
            <p>© ${new Date().getFullYear()} GState. All rights reserved.</p>
          </div>
        </div>
      </body>
    </html>
